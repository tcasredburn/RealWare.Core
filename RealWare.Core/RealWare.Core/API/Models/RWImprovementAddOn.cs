...
{
    public class RWImprovementAddOn : RWBase
    {
        [Required]
        public long AddonCode
        {
            get;
            set;
        }
        ...
        public bool CostImpDetailOverrideFlag
        {
            get;
            set;
        }
        ...
        public int? OverrideLifeExpectancy
        {
            get;
            set;
        }
